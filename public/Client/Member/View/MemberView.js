                ...
                <div class="main-center">
                    <div class="column-align">
                        ...
                        <div class="search-result-container">
                            <label>차량번호: <h3 class="search-result-item js-member-search-result">${user_car_number}</h3></label>
                            <label>등록일자: <h3 class="search-result-item js-member-search-result">${pay_date}</h3></label>
                            <label>만료일자: <h3 class="search-result-item js-member-search-result">${expire_date}</h3></label>
                        </div>
        ...
        <div class="main-container-no-img row-align">
            <div class="main-container-stretch">
                ...
                <div class="postpone-column-align">
                    <form class="js-member-search-form">
                        <label>차량 번호: <input type="text" name="user_car_number"></label>
                        <button type="submit" class="js-member-search-btn">검색</button>
                    </form>
                    ...
                    <form class="postpone-form js-postpone-form">
                        <hidden name="user_car_number" value="${user_car_number}"></hidden>
                        <label>연기할 날짜: <input type="date" name="postpone_date"></label>
...
`;
  ...
  makeMemberInfo(user_car_number, pay_date, expire_date, user_state, pay_method, left_days) {
    return ` 
    <main>
        <div class="main-container-no-img row-align">
            <div class="main-container-stretch">
                ...
                <div class="main-center">
                    <div class="column-align">
                        <div class="search-result-container">
                            <label>차량 번호: <h3 class="search-result-item js-member-search-result">${user_car_number}</h3></label>
                            <label>등록 일자: <h3 class="search-result-item js-member-search-result">${pay_date}</h3></label>
                            <label>만료 일자: <h3 class="search-result-item js-member-search-result">${expire_date}</h3></label>
                            <label>멤버 상태: <h3 class="search-result-item js-member-search-result">${user_state}</h3></label>
                            <label>결제 수단: <h3 class="search-result-item js-member-search-result">${pay_method}</h3></label>
                            <label>남은 기간: <h3 class="search-result-item js-member-search-result">${left_days}</h3></label>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="main-container-stretch">
                ...
                <div class="center-align">
                    <form class="form-align js-member-login-form">
                        <div>
                            <label class="admin-login-id">차량 번호: <input type="text" name="user_car_number"></label>
                        </div>
                        <div><label>Password: <input type="password" name="member_pw"></label>
