                ...
                <div class="check-form">
                    <form class="form-align js-check-car-form">
                        ...
                        <div class="check-weight-input"><label>차량 무게: <input type="text" name="car_weight"
                                    placeholder="단위: Kg" required></label></div>
                        <div><label>차량 높이: <input type="text" name="car_height" placeholder="단위: m" required></label>
            ...
            <div class="main-container-stretch">
                ...
                <div class="center-align">
                    <form class="js-pay-cash-form">
                        <label class="input-block margin-left-15">총 금액: <input class="js-bill" name="bill" readonly="readonly"></label>
                        <label>지불 금액: <input type="text" name="input_money" required></label>
        ...
        <div class="main-container-stretch">
            ...
            <div class="center-align">
                <form class="js-pay-card-form">
                    <label class="input-block minus-margin-20">총 금액: <input class="js-bill" name="bill" readonly="readonly"></label>
        ...
        <div class="main-container-stretch">
            ...
            <div class="main-center">
                <div class="margin-top">
                    <form class="js-register-form width-400">
                        <div class="block-form">
                            <label class="minus-margin-left-35">차량 번호: <input type="text" name="car_number" required></label>
                        </div>
